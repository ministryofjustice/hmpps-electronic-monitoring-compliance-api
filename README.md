# hmpps-electronic-monitoring-compliance-api

[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-electronic-monitoring-compliance-api/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-electronic-monitoring-compliance-api)
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-electronic-monitoring-compliance-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://electronic-monitoring-compliance-api-dev.hmpps.service.justice.gov.uk/swagger-ui/index.html)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-electronic-monitoring-compliance-api/security/policy).
...
## Renaming from HMPPS Electronic Monitoring Compliance Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-electronic-monitoring-compliance-api=0
```
