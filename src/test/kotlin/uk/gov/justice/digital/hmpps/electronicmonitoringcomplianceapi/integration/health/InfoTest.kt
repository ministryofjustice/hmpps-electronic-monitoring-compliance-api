package uk.gov.justice.digital.hmpps.electronicmonitoringcomplianceapi.integration.health
...
class InfoTest(
  ...
  fun `Info page is accessible`() {
    webTestClient.get()
      ...
      .isOk
      .expectBody()
      .jsonPath("build.name").isEqualTo("hmpps-electronic-monitoring-compliance-api")
  }
